...
def classify(document):
    label = {0:'지구한바퀴_세계여행', 1:'그림·웹툰', 2:'시사·이슈', 3:'IT_트렌드',4:'사진·촬영', 5:'취향저격_영화_리뷰', 6:'오늘은_이런_책', 7:'뮤직_인사이드', 8:'글쓰기_코치',
    9:'직장인_현실_조언', 10:'스타트업_경험담', 11:'육아_이야기', 12:'요리·레시피',
    13:'건강·운동',14:'멘탈_관리_심리_탐구', 15:'디자인_스토리', 16:'문화·예술',
    17:'건축·설계', 18:'인문학·철학',19:'쉽게_읽는_역사', 20:'우리집_반려동물',
    21:'감성_에세이'}
...
def correction_category():
    ...
    '쉽게_읽는_역사':19, '우리집_반려동물':20,'감성_에세이':21}
